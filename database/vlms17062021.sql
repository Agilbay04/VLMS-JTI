...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Jun 2021 pada 15.02
...
INSERT INTO `anggota` (`id_anggota`, `nama_anggota`, `no_identitas`, `status`, `bidang`, `id_grup`, `gambar`, `password`) VALUES
(1, 'Agil Wijaya', '255', 'Mahasiswa', 'Robotika', 3, '9jBNPwYEWKmFg3U.png', '202cb962ac59075b964b07152d234b70'),
(2, 'Angga gumilang', '', 'Dosen', 'Robotika', 1, 'vHBa9Tqlp1khVRg.jpg', '');
...
(1, 'help me tolong', 2, '<p>uifhsfhiaip <b>fkskfosof</b></p>', 2, 2, '2021-05-27 13:03:27', 'gusZyKv9Q5cfbp1.jpg', 0);
...
(3, 'garis 3', '', '', '', '', '', ''),
(4, 'garis 4', '', '', '', '', '', ''),
(5, 'garis 5', 'Kampus 1 Jember', 'Ksi', 'jalan letjen suprapto', 'farhan@polije.ac.id', '089647276534', '(0331) 333531');
...
(1, 'Pendeteksi virus', 'Digunakan pada rumah sakit tingkat atas', 'Z36xr8cngekLPWu.jpg', 2);
