...
<body>
        ...
        <div class="row px-3">
            <div class="card flex-row mx-auto px-0 col-lg-10 col-xl-9">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('login/aksi_login') ?>" class="form-box px-3" method="POST">
                        <div class="form-input">
                            <span><i class="fas fa-id-card"></i></span>
                            <input type="text" name="username" id="nim" placeholder="NIM Anda..." tabindex="10" required>
                        </div>
                        <div class="form-input">
                        ...
                        <div class="text-right">
                            <a href="../auth/forget.html" class="forget-link">
                                Lupa password?
                            </a>
                        </div>
    ...
    <!-- main js -->
    <script src="<?= base_url('assets/user') ?>/js/auth.js"></script>
</body>
